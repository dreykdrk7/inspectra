...
| `INSPECTRA_SESSION_TTL_SECONDS` | backend | `3600` | Single-admin in-memory session TTL and session-cookie max age. Login/logout endpoints use it for the `inspectra_session` cookie; frontend login and CSRF protection are still separate future work. |
