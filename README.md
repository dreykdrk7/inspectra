...
- It does not implement Active / DNS inventory runtime yet; no AXFR, provider DNS/API import, broad subdomain enumeration, CT/passive-DNS runtime, raw DNS packet storage, or complete-zone result is added by the DNS inventory design phase.
