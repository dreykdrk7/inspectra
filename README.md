...
| `INSPECTRA_ADMIN_PASSWORD_HASH` | backend | unset | Reserved future single-admin credential hash. Current runtime only reports whether it is configured through `GET /auth/status`; it does not implement login or return the hash. |
