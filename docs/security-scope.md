...
- Active frontend UI now includes a separate dry-run panel, required authorization, `POST /active/network/dry-run` client call, catalog/filter label, job report, and redacted Raw JSON.
